...
function displayToc(filter){var numDisplayed=0;var tocTable='';var tocHead1='Judul Artikel';var tocTool1='Click to sort by title';var tocHead2='Tanggal';var tocTool2='Click to sort by date';var tocHead3='Kategori';var tocTool3='';if(sortBy=="titleasc"){tocTool1+=' (descending)';tocTool2+=' (newest first)';}
...
tocTable+='</table>';if(numDisplayed==postTitle.length){var tocNote='<span class="toc-note"> Jumlah Artikel '+postTitle.length+' pos<br/></span>';}
else{var tocNote='<span class="toc-note">Menampilkan '+numDisplayed+' artikel kategori \'';tocNote+=postFilter+'\' *** dari '+postTitle.length+' artikel<br/></span>';}
